...
- React Navigation
- Context API
- OpenAI GPT para busca inteligente
- Axios para requisições HTTP

## Funcionalidades
- Navegação entre telas
- Pesquisa de produtos usando IA
- Carrinho de compras
- Listagem de produtos
- Armazenamento local (AsyncStorage)

## Projeto
<img width="500" height="600" alt="image" src="https://github.com/user-attachments/assets/4a407264-e5cf-4ff6-af28-c9861fffa7f5"  />
<img width="500" height="600" alt="image" src="https://github.com/user-attachments/assets/fb274b20-5d20-4ba7-ab4f-e205ffd7104e"  />
